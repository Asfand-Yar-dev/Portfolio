...
export default function Contact({ isDarkMode }) {
  ...
  const socialLinks = [
    { icon: <FaLinkedinIn size={20} />, url: 'https://www.linkedin.com/in/asfandyar100/', color: 'text-[#0077B5]' },
    { icon: <FaGithub size={20} />, url: 'https://github.com/Asfand-Yar-dev', color: 'text-[#212830]' },
    { icon: <FaTwitter size={20} />, url: 'https://twitter.com/Asfand_Yar007', color: 'text-[#1DA1F2' },
  ];
